...
public partial class Ryofu_Common : PlayerBase
{
    private StateMachine<Ryofu_Common> _stateMachine;
    ...
    private void Start()
    {
        ...
        _stateMachine = new StateMachine<Ryofu_Common>(this);
        _stateMachine.AddTransition<Ryofu_Idle, Ryofu_SkillOne>((int)Event.Skill_1);
        _stateMachine.AddTransition<Ryofu_Idle, Ryofu_SkillTwo>((int)Event.Skill_2);
        _stateMachine.AddAnyTransition<Ryofu_Idle>((int)Event.Idle);
        _stateMachine.AddAnyTransition<Ryofu_Dead>((int)Event.Dead);
        _animator = GetComponent<Animator>();
        _stateMachine.Start<Ryofu_Idle>();
    }
