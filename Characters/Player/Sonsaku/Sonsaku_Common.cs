...
public partial class Sonsaku_Common : PlayerBase
{
    private StateMachine<Sonsaku_Common> _stateMachine;
    private void Start()
    {
        ...
        _stateMachine = new StateMachine<Sonsaku_Common>(this);
        _stateMachine.AddTransition<Sonsaku_Idle, Sonsaku_Skill_One>((int)Event.Skill_1);
        _stateMachine.AddTransition<Sonsaku_Idle, Sonsaku_Skill_Two>((int)Event.Skill_2);
        _stateMachine.AddAnyTransition<Sonsaku_Idle>((int)Event.Idle);
        _stateMachine.AddAnyTransition<Sonsaku_Dead>((int)Event.Dead);
        _animator = GetComponent<Animator>();
        _stateMachine.Start<Sonsaku_Idle>();
    }
